...
Take some interesting models from ModelScope for personal use. Tasks are queue-based, as small low-end servers cannot handle them.

Web creates tasks, server starts Celery to consume tasks. Multiple consumers can be started on multiple servers to process tasks.
